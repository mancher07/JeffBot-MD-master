...
╰━━━━━━━━━━━━━━━━⬣
*» Premium ➺ ${user.premiumTime > 9999999 ? '✅' : '❌'}* ${(conn.user.jid == global.conn.user.jid ? '' : `\n» *Sub bot del:* wa.me/${global.conn.user.jid.split`@`[0]}`) || ''}
...
handler.command = /^(abrir|menú|memu|memú|help|info|comandos|2help|menu1.2|ayuda|commands|commandos|m|\?)$/i
