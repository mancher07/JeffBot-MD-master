...
try {
let res = await axios.get(`https://api.zahwazein.xyz/searching/pixiv?query=yuri&apikey=${keysxxx}&query=${text}`)
let json = res.data
let listSerch = []
...
m.reply('*𝑼𝒇𝒇, 𝒔𝒆 𝒎𝒆 𝒄𝒂𝒚𝒐́ 𝒆𝒍 𝒔𝒆𝒓𝒗𝒊𝒅𝒐, 𝒗𝒖𝒆𝒍𝒗𝒂 𝒂𝒍 𝒊𝒏𝒕𝒆𝒏𝒕𝒂𝒓pixiv*')
}}
handler.command = /^pixiv|pixiv2$/i
//handler.level = 9
handler.limit = 6
